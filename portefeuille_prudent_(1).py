...
st.title("Simulateur de portefeuille prudent 🛡️📊")
...
if all(uploaded_files.values()):
    ...
    rendement_annuel = st.slider("Rendement annuel (%)", 1.0, 10.0, 3.0) / 100
    ...
    ax.set_title("Évolution de la valeur du portefeuille prudent")
    ax.set_xlabel("Date")
